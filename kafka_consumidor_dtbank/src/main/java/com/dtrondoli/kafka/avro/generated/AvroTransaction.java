...
public class AvroTransaction extends org.apache.avro.specific.SpecificRecordBase
		implements org.apache.avro.specific.SpecificRecord {
	private static final long serialVersionUID = 7063915052668222079L;
	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse(
			"{\"type\":\"record\",\"name\":\"AvroTransaction\",\"namespace\":\"com.dtrondoli.kafka.avro.generated\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"accountSource\",\"type\":[\"null\",\"long\"]},{\"name\":\"accountTarget\",\"type\":[\"null\",\"long\"]},{\"name\":\"amount\",\"type\":\"double\"},{\"name\":\"type\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
	...
	private static final BinaryMessageEncoder<AvroTransaction> ENCODER = new BinaryMessageEncoder<AvroTransaction>(
			MODEL$, SCHEMA$);

	private static final BinaryMessageDecoder<AvroTransaction> DECODER = new BinaryMessageDecoder<AvroTransaction>(
			MODEL$, SCHEMA$);
	 ...
	 */
	public static AvroTransaction fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
	...
	public long id;
	@Deprecated
	public java.lang.Long accountSource;
	@Deprecated
	public java.lang.Long accountTarget;
	@Deprecated
	 ...
	 */
	public AvroTransaction(java.lang.Long id, java.lang.Long accountSource, java.lang.Long accountTarget,
			java.lang.Double amount, java.lang.String type) {
		this.id = id;
	...
	public void put(int field$, java.lang.Object value$) {
		...
		case 0:
			...
			break;
		case 1:
			accountSource = (java.lang.Long) value$;
			break;
		case 2:
			accountTarget = (java.lang.Long) value$;
			break;
		case 3:
	 ...
	 */
	public static com.dtrondoli.kafka.avro.generated.AvroTransaction.Builder newBuilder(
			com.dtrondoli.kafka.avro.generated.AvroTransaction.Builder other) {
		if (other == null) {
			return new com.dtrondoli.kafka.avro.generated.AvroTransaction.Builder();
		} else {
	...
	/**
	 * Creates a new AvroTransaction RecordBuilder by copying an existing
	 * AvroTransaction instance.
	 * 
	 * @param other The existing instance to copy.
	 * @return A new AvroTransaction RecordBuilder
	 */
	public static com.dtrondoli.kafka.avro.generated.AvroTransaction.Builder newBuilder(
			com.dtrondoli.kafka.avro.generated.AvroTransaction other) {
		if (other == null) {
			return new com.dtrondoli.kafka.avro.generated.AvroTransaction.Builder();
		} else {
			return new com.dtrondoli.kafka.avro.generated.AvroTransaction.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroTransaction>
		...
		public AvroTransaction build() {
			try {
				...
				record.accountSource = fieldSetFlags()[1] ? this.accountSource
						: (java.lang.Long) defaultValue(fields()[1]);
				record.accountTarget = fieldSetFlags()[2] ? this.accountTarget
	...
	@SuppressWarnings("unchecked")
	private static final org.apache.avro.io.DatumWriter<AvroTransaction> WRITER$ = (org.apache.avro.io.DatumWriter<AvroTransaction>) MODEL$
	...
	@SuppressWarnings("unchecked")
	private static final org.apache.avro.io.DatumReader<AvroTransaction> READER$ = (org.apache.avro.io.DatumReader<AvroTransaction>) MODEL$
